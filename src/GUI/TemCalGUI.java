...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           // Begging of the Data Table Panel /////////////////////////////////////////////////////////////////////
			...
			String[] ColumnName = {"Variable Name", "dominant veg", "understory"};
	    ...
	    private void getDefaultvarparFromTEM(){
	    	try {
	    		...
	    		if (vegcov>0.) {
	    				...
	    				Caliber.temcj.getVbCalPar();   // pass TEM read-in pars to 'temcj' for passing below
	    				dumvpar = Caliber.temcj.getVcalpar();  // passing pars from 'temcj' to GUI

	    				calparTB.setValueAt(Double.toString(dumvpar.getCmax()), Configurer.I_CMAX, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getNmax()), Configurer.I_NMAX, 1);

	    				calparTB.setValueAt(Double.toString(dumvpar.getCfall()[0]), Configurer.I_CFALLL, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getCfall()[1]), Configurer.I_CFALLS, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getCfall()[2]), Configurer.I_CFALLR, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getNfall()[0]), Configurer.I_NFALLL, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getNfall()[1]), Configurer.I_NFALLS, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getNfall()[2]), Configurer.I_NFALLR, 1);

	    				calparTB.setValueAt(Double.toString(dumvpar.getKra()), Configurer.I_KRA, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getKrb()[0]), Configurer.I_KRBL, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getKrb()[1]), Configurer.I_KRBS, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getKrb()[2]), Configurer.I_KRBR, 1);
	    				calparTB.setValueAt(Double.toString(dumvpar.getFrg()), Configurer.I_FRG, 1);
	    		...
	    		// initial states
    			if (vegcov>0.) {
	    				Caliber.temcj.getInitVbState();

	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitvegc()[0]), Configurer.I_VEGCL, 1);
	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitvegc()[1]), Configurer.I_VEGCS, 1);
	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitvegc()[2]), Configurer.I_VEGCR, 1);
	    		
	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitvegn()[0]), Configurer.I_VEGNL, 1);
	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitvegn()[1]), Configurer.I_VEGNS, 1);
	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitvegn()[2]), Configurer.I_VEGNR, 1);

	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitdeadc()), Configurer.I_DEADC, 1);
	    				stateTB.setValueAt(Double.toString(Caliber.temcj.getInitdeadn()), Configurer.I_DEADN, 1);
...
//////////////////////////////////////////////////////////////////////////////
	...
	private void getCalparFromChangerToTable(){
		
		try {

			calparTB.setValueAt(String.valueOf(cmaxChanger.getValue()), Configurer.I_CMAX, 1);
			calparTB.setValueAt(String.valueOf(nmaxChanger.getValue()), Configurer.I_NMAX, 1);

			calparTB.setValueAt(String.valueOf(cfalllChanger.getValue()), Configurer.I_CFALLL, 1);
			calparTB.setValueAt(String.valueOf(cfallsChanger.getValue()), Configurer.I_CFALLS, 1);
			calparTB.setValueAt(String.valueOf(cfallrChanger.getValue()), Configurer.I_CFALLR, 1);

			calparTB.setValueAt(String.valueOf(nfalllChanger.getValue()), Configurer.I_NFALLL, 1);
			calparTB.setValueAt(String.valueOf(nfallsChanger.getValue()), Configurer.I_NFALLS, 1);
			calparTB.setValueAt(String.valueOf(nfallrChanger.getValue()), Configurer.I_NFALLR, 1);

			calparTB.setValueAt(String.valueOf(kraChanger.getValue()), Configurer.I_KRA, 1);
			calparTB.setValueAt(String.valueOf(krblChanger.getValue()), Configurer.I_KRBL, 1);
			calparTB.setValueAt(String.valueOf(krbsChanger.getValue()), Configurer.I_KRBS, 1);
			calparTB.setValueAt(String.valueOf(krbrChanger.getValue()), Configurer.I_KRBR, 1);
			calparTB.setValueAt(String.valueOf(frgChanger.getValue()), Configurer.I_FRG, 1);
		...
		private void readCalbgcFromFile(){
		    ...
		    try {
			    ...
			    if(!drvF.exists()){
			    	...
			    	element = element[0].split("\\s+", 2);
			    	if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_GPPt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_INNPPt, 1);
			    	...
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_NPPt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("\\s+");
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_NUPTAKEt, 1);

			    	dummy = input.readLine();			    	
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_VEGCLt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_VEGCSt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_VEGCRt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_VEGNLt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_VEGNSt, 1);
			    	
			    	dummy = input.readLine();
			    	element = dummy.split("//", 2);
			    	element = element[0].split("\\s+", 2);
		    		if (vegcov>0.)			    		
			    		targetTB.setValueAt(element[0].trim(), Configurer.I_VEGNRt, 1);
	...
	public class InitCaliparSelector implements ActionListener{
		...
		private void readInitparFromFile(){
		    ...
		    try {
			    ...
			    if(!parF.exists()){
			    	...
			    	element = dummy.split("\\s+", 2);    // unknown number white space as data delimiter
		    		if (vegcov>0.) {	
			    		calparTB.setValueAt(element[0].trim(), Configurer.I_CMAX, 1);
			    	}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
			    		calparTB.setValueAt(element[0].trim(), Configurer.I_NMAX, 1);
			    	}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
			    		calparTB.setValueAt(element[0].trim(), Configurer.I_CFALLL, 1);
			    	}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_CFALLS, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_CFALLR, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_NFALLL, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_NFALLS, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_NFALLR, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_KRA, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_KRBL, 1);
		      		}

		      		dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_KRBS, 1);
		      		}

			    	dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_KRBR, 1);
		      		}

		      		dummy = input.readLine().split("//", 2)[0];
			    	element = dummy.split("\\s+", 2);
			    	if (vegcov>0.) {			    		
		      			calparTB.setValueAt(element[0].trim(), Configurer.I_FRG, 1);
		      		}
		...
		private void assignCalparTableToChanger(){
			
			try {

				cmaxChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_CMAX, 1)), 1);
				nmaxChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_NMAX, 1)), 0);

				cfalllChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_CFALLL, 1)), -2);
				cfallsChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_CFALLS, 1)), -2);
				cfallrChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_CFALLR, 1)), -2);

				nfalllChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_NFALLL, 1)), -2);
				nfallsChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_NFALLS, 1)), -2);
				nfallrChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_NFALLR, 1)), -2);

				kraChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRA, 1)), -5);
				krblChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRBL, 1)), -1);
				krbsChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRBS, 1)), -1);
				krbrChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRBR, 1)), -1);
				frgChanger.updateValue(Double.valueOf((String) calparTB.getValueAt(Configurer.I_FRG, 1)), -2);
		...
		private void setTEMparsFromTable(){
			...
			// veg. parameters needed for all PFTs
				...
				if (vegcov>0.) {
					parval=Double.valueOf((String) calparTB.getValueAt(Configurer.I_CMAX, 1));
					dvcalpar.setCmax(parval);
					parval=Double.valueOf((String) calparTB.getValueAt(Configurer.I_NMAX, 1));
					dvcalpar.setNmax(parval);

					parval2[0]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_CFALLL, 1));
					parval2[1]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_CFALLS, 1));
					parval2[2]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_CFALLR, 1));
					dvcalpar.setCfall(parval2);

					parval2[0]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_NFALLL, 1));
					parval2[1]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_NFALLS, 1));
					parval2[2]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_NFALLR, 1));
					dvcalpar.setNfall(parval2);

					parval=Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRA, 1));
					dvcalpar.setKra(parval);

					parval2[0]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRBL, 1));
					parval2[1]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRBS, 1));
					parval2[2]=Double.valueOf((String) calparTB.getValueAt(Configurer.I_KRBR, 1));
					dvcalpar.setKrb(parval2);

					parval=Double.valueOf((String) calparTB.getValueAt(Configurer.I_FRG, 1));
					dvcalpar.setFrg(parval);

					// pass the parameters 
					Caliber.temcj.setVbCalPar1pft(dvcalpar);
				}
...
//------ Operations on Calibration Tab of Control Panel --------------------------------------
	...
	private void setTEMinitstateFromTable(){
		...
		double vegcov = Caliber.eqrunner.runcht.cht.getCd().getM_veg().getVegcov();
	      ...
	      if (vegcov>0.) {
	    	  dummy[0]=Double.valueOf((String) stateTB.getValueAt(Configurer.I_VEGCL, 1));
	    	  dummy[1]=Double.valueOf((String) stateTB.getValueAt(Configurer.I_VEGCS, 1));
	    	  dummy[2]=Double.valueOf((String) stateTB.getValueAt(Configurer.I_VEGCR, 1));
	    	  Caliber.temcj.setInitvegc(dummy);

	    	  dummy[0]=Double.valueOf((String) stateTB.getValueAt(Configurer.I_VEGNL, 1));
	    	  dummy[1]=Double.valueOf((String) stateTB.getValueAt(Configurer.I_VEGNS, 1));
	    	  dummy[2]=Double.valueOf((String) stateTB.getValueAt(Configurer.I_VEGNR, 1));
	    	  Caliber.temcj.setInitvegn(dummy);

	    	  Caliber.temcj.setInitdeadc(Double.valueOf((String) stateTB.getValueAt(Configurer.I_DEADC, 1)));
	    	  Caliber.temcj.setInitdeadc(Double.valueOf((String) stateTB.getValueAt(Configurer.I_DEADN, 1)));

	    	  Caliber.temcj.setInitVbState();
	      }
	...
	public class Setup implements ActionListener{
		...
		private void setTEMcalparsFromChanger(){
			...
			Caliber.temcj.setVbCalPar1pft(Caliber.jvcalpar);
