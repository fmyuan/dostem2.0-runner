...
public class TEMccjava {
  ...
  public void setEd(EnvData value) {
    temcoreJNI.TEMccjava_ed_set(swigCPtr, this, EnvData.getCPtr(value), value);
  }

  public EnvData getEd() {
    long cPtr = temcoreJNI.TEMccjava_ed_get(swigCPtr, this);
    return (cPtr == 0) ? null : new EnvData(cPtr, false);
  }

  public void setBd(BgcData value) {
    temcoreJNI.TEMccjava_bd_set(swigCPtr, this, BgcData.getCPtr(value), value);
  }

  public BgcData getBd() {
    long cPtr = temcoreJNI.TEMccjava_bd_get(swigCPtr, this);
  ...
  public void setVcalpar(vegpar_cal value) {
    temcoreJNI.TEMccjava_vcalpar_set(swigCPtr, this, vegpar_cal.getCPtr(value), value);
  }

  public vegpar_cal getVcalpar() {
    long cPtr = temcoreJNI.TEMccjava_vcalpar_get(swigCPtr, this);
  ...
  public void setInitVbState() {
    temcoreJNI.TEMccjava_setInitVbState(swigCPtr, this);
  }
  ...
  public void setVbCalPar1pft(vegpar_cal jvcalpar) {
    temcoreJNI.TEMccjava_setVbCalPar1pft(swigCPtr, this, vegpar_cal.getCPtr(jvcalpar), jvcalpar);
  }
  ...
  public void getInitVbState() {
    temcoreJNI.TEMccjava_getInitVbState(swigCPtr, this);
  }
  ...
  public void getVbCalPar() {
    temcoreJNI.TEMccjava_getVbCalPar(swigCPtr, this);
  }
  ...
  public void getData() {
    temcoreJNI.TEMccjava_getData(swigCPtr, this);
  }
