...
public class OutRetrive {
  ...
  public void setEnvoddly(SWIGTYPE_p_EnvDataDly value) {
    temcoreJNI.OutRetrive_envoddly_set(swigCPtr, this, SWIGTYPE_p_EnvDataDly.getCPtr(value));
  }

  public SWIGTYPE_p_EnvDataDly getEnvoddly() {
  ...
  public void setProcessData(EnvData edp, BgcData bdp) {
    temcoreJNI.OutRetrive_setProcessData(swigCPtr, this, EnvData.getCPtr(edp), edp, BgcData.getCPtr(bdp), bdp);
  }
  ...
  public void assignSiteDlyOutputBuffer_Env(snwstate_dim d_snow, int iday) {
    temcoreJNI.OutRetrive_assignSiteDlyOutputBuffer_Env(swigCPtr, this, snwstate_dim.getCPtr(d_snow), d_snow, iday);
  }
