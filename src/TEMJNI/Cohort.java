...
public class Cohort {
  ...
  public SWIGTYPE_p_Vegetation_Env getVegenv() {
    return new SWIGTYPE_p_Vegetation_Env(temcoreJNI.Cohort_vegenv_get(swigCPtr, this), true);
  }
  ...
  public SWIGTYPE_p_Vegetation_Bgc getVegbgc() {
    return new SWIGTYPE_p_Vegetation_Bgc(temcoreJNI.Cohort_vegbgc_get(swigCPtr, this), true);
  }
  ...
  public void setProcessData(FirData fdp) {
    temcoreJNI.Cohort_setProcessData(swigCPtr, this, FirData.getCPtr(fdp), fdp);
  }
